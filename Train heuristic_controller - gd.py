""" 
** Code for Reward Function A in the paper **

This script contains drone training code with Venilla Gradient Decent optimizer

Optimizer: 
    Venilla gradient ascent
Reward funciton: 
    +1 for every step towards targte (distance calculated using euclidean distance)
    -1 Otherwise
    +2 On reaching the target       
...
class HeuristicController(FlightController):
    ...
    def train(self, save_path):
        ...
        params = [1.0, 0.5, 0.1, 0.3]   ## Initial parameter values    
        grads = [0, 0, 0, 0]
        ...
        for n in range(epochs):
            ...
            ## Log the data of current epoch before updating params
